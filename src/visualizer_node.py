...
from platforms_server.msg import FieldObjects as FieldObjects_msg, All_pathes


class Visualizer():
    def __init__(self):
        self.bridge = CvBridge()
        self.IMG = np.zeros((480, 480))
        ...
        path_sub = rospy.Subscriber("paths_data", All_pathes, self.paths_callback)
